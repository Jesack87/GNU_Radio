...
# timestamps = np.linspace(0, 6.28, 15, endpoint=False)
# y = np.sin(timestamps)
# z = np.cos(2*timestamps)
# v = np.sin(3*timestamps)
# t = np.sin(4*timestamps)
# plt.subplot(411)
# plt.plot(timestamps, y, marker="$S$", color="blue", linestyle= "-", markersize=10, linewidth=3, label="sine")
# plt.legend(loc="upper right")
# plt.subplot(412)
...
# plt.legend(loc="upper right")
# plt.subplot(414)
# plt.plot(timestamps, v, marker="$C$", color="purple", linestyle= "-", markersize=10, linewidth=3, label="cosine")
# plt.legend(loc="upper right")
# plt.tight_layout()
# plt.show()
